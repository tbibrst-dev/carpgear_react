...
<div style="width: 100%; max-width: 450px; margin: auto;">
    <div style="display: block; gap: 24px;">
        ...
        <!-- <div style="margin-top:24px;">
            ...
            <p
                ...
                Competition:<?php printf(esc_html($comp_title)); ?>
            </p>
    ...
    <h4
        style="width: 360px;height: 29px;max-width: 360px; margin: 20px auto 0; font-family: 'Roboto', sans-serif; font-size: 15px; font-weight: 600; line-height: 18px; text-align: center; color: #FFFFFF;">
