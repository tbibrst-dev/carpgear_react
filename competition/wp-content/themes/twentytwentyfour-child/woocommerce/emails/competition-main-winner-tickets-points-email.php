...
<div style="width: 100%; max-width: 450px; margin: auto;">
    <div style="display: block; gap: 24px;">
        ...
        <div style="margin-top:24px;">
            ...
            <p class="competition-title"
                ...
                <?php printf(esc_html($main_comp_title)); ?>
            </p>
        </div>
                ...
                <tr>
                    ...
                    <td style="padding-left: 15px; vertical-align: middle;">
                        <h1
                            ...
                            <?php printf(esc_html($total_tickets)); ?> Tickets
                        </h1>
                        <div
    ...
    <?php if ($add_additional_info == 1): ?>
        <h4
            style="width: 450px;height: 29px;max-width: 450px; margin: 20px 0px; font-family: 'Roboto', sans-serif; font-size: 15px; font-weight: 600; line-height: 18px; text-align: center; color: #FFFFFF;">
            The tickets you have won would take you over the entry limit into <?php echo $comp_title; ?> by
            <?php echo $total_tickets; ?> tickets. We have awarded you <?php echo $points; ?> points to your account.
            The number of points matches the price of exceeding tickets.
        </h4>
    <?php endif; ?>
</div>