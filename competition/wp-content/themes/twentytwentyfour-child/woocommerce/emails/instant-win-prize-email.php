...
<div style="width: 100%; max-width: 450px; margin: auto;">
    <div style="display: block; gap: 24px;">
        ...
        <p
            ...
            You’ve won an Instant Win prize!
        </p>
    ...
    <?php
    $claimURL = FRONTEND_URL."claim/prize?competition_name=$comp_title&competition_type=instant&prize_name=$title&prize_id=$prize_id&competition_id=$competition_id&order=$order&ticket_number=$ticket_number&user_id=$user_id&cash_alt=$cash";
    ?>
    <p>
