...
?>
<div class="checkout-section-login mob-log-section-hide" id="desktop_login" <?php if(!isset($_REQUEST['show_login_form'])) echo 'style="display:none;"'; ?>>

	<div class="woocommerce-form woocommerce-form-login loginn" method="post">
		...
		<div class="log-on">
			<div class="form-group">
				...
				<input type="hidden" name="show_login_form" value="1" />
			</div>
		</div>
		<div class="forgot-password lost_password">
		<!-- wp_lostpassword_url() -->
			<a
				href="<?php echo $frontend_url."auth/forgot/password" ?>"><?php esc_html_e('Forgot password?', 'woocommerce'); ?></a>
		</div>
