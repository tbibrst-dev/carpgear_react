						...
						<?php
							woocommerce_wp_checkbox(
								array(
									...
									'description' => __( 'Allow users to choose when multiples are added on the above.<br>(<em style="color: #ff6666; margin-top: 10px; font-weight: bold;">Note: Currently, this feature is available for WooCommerce Blocks only.</em>)', 'woocommerce-smart-coupons' ),
								)
							);
						?>
					</p>
