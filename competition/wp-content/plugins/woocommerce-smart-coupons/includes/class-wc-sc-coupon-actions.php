			...
			if ( ! empty( $coupon_actions ) && ! is_scalar( $coupon_actions ) ) {
				...
				foreach ( $coupon_actions as $coupon_action ) {
					...
					if ( $order instanceof WC_Abstract_Order ) {
						...
						if ( ! is_admin() && ( wp_doing_ajax() || ( WC()->is_rest_api_request() && 'yes' !== $no_of_selectable_product ) || 'yes' === $is_auto_apply || $wc_sc_url_coupon->is_coupon_applied_via_url( $coupon_code ) ) ) {
