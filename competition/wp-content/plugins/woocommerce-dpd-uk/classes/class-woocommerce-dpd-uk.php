...
use WPDesk\DpdUk\Integrations\WooCommerceGatewayStripeIntegration;
	...
	class WPDesk_WooCommerce_DPD_UK {
		...
		public function init_services_verifier() {
			if ( function_exists( 'wc_empty_cart' ) ) {
				...
				( new WooCommerceGatewayStripeIntegration( $services_verifier ) )->hooks();
			}
		}
		...
		public function woocommerce_review_order_after_shipping() {
			...
			foreach ( $packages as $id => $package ) {
				...
				if ( 'dpd_uk' === $shipping_method['method_integration'] ) {
