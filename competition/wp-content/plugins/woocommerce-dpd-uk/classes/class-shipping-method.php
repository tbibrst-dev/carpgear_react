...
class WPDesk_WooCommerce_DPD_UK_Shipping_Method extends WC_Shipping_Method {
	...
	const SHIPPING_METHOD_ID = 'dpd_uk';
	...
	const SETTING_INVOICE_VAT_NUMBER = 'invoice_tax_vat_number';
	const SETTING_INVOICE_EORI_NUMBER = 'invoice_vat_number';
	...
	public function __construct( $instance_id = 0 ) {
		...
		$this->method_description = __(
			'DPD UK WooCommerce Integration. <a href="https://octol.io/dpd-uk-settings-docs" target="_blank">Refer to the instruction manual &rarr;</a>',
			'woocommerce-dpd-uk'
		);
	...
	public function init_form_fields() {
		...
		if ( $flexible_printing ) {
			if ( 'yes' === $this->get_option( 'auto_print', '' ) ) {
				$flexible_printing_integration_url = apply_filters(
					'flexible_printing_integration_url',
			...
			$flexible_printing_buy_url    = 'https://octol.io/dpd-uk-printing-cross';
			$auto_print_description       = sprintf(
		...
		$this->form_fields = [
			...
			self::SETTING_HOUR_CHANGING_SHIPMENT_DATE         => [
				...
				'options'     => [
					...
					'0'  => __( '12 am', 'woocommerce-dpd-uk' ),
					'1'  => __( '1 am', 'woocommerce-dpd-uk' ),
					'2'  => __( '2 am', 'woocommerce-dpd-uk' ),
					'3'  => __( '3 am', 'woocommerce-dpd-uk' ),
					'4'  => __( '4 am', 'woocommerce-dpd-uk' ),
					'5'  => __( '5 am', 'woocommerce-dpd-uk' ),
					'6'  => __( '6 am', 'woocommerce-dpd-uk' ),
					'7'  => __( '7 am', 'woocommerce-dpd-uk' ),
					'8'  => __( '8 am', 'woocommerce-dpd-uk' ),
					'9'  => __( '9 am', 'woocommerce-dpd-uk' ),
				...
				'description' => __(
					'Select the hour after which the date of shipment will be set for the next day.',
					'woocommerce-dpd-uk'
				),
				'desc_tip'    => true,
			],
			...
			'complete_order'                                  => [
				...
				'default'     => 'no',
				'description' => __(
					'Automatically change order status to completed after creating shipment.',
					'woocommerce-dpd-uk'
				),
				'desc_tip'    => true,
			],
			...
			self::SETTING_FIELD_LABEL_FORMAT                  => [
			...
			self::SETTING_FIELD_LABEL_ACTION                  => [
			...
			'email_tracking_number'                           => [
				...
				'class'       => 'dpd_uk_settings_email_notifications',
				'description' => __(
					'Add DPD tracking number and link to the WooCommerce confirmation emails.',
					'woocommerce-dpd-uk'
				),
				'default'     => 'no',
				'desc_tip'    => true,
			...
			[
				...
				'description' => __(
					'Invoice details are required to create international shipments.',
					'woocommerce-dpd-uk'
				),
			],
			self::SETTING_INVOICE_COUNTRY_OF_ORIGIN           => [
				'title'       => __( 'Country of Origin', 'woocommerce-dpd-uk' ),
				'type'        => 'select',
				'class'       => 'dpd_uk_settings_invoice_details select2',
				'options'     => WC()->countries->get_countries(),
				'description' => __(
					'Declare which country your products were manufactured or produced in.',
					'woocommerce-dpd-uk'
				),
				'desc_tip'    => true,
			],
			self::SETTING_INVOICE_CUSTOMS_NUMBER              => [
			...
			self::SETTING_INVOICE_EXPORT_REASON               => [
			...
			self::SETTING_INVOICE_TERMS_OF_DELIVERY           => [
				...
				// Translators: docs link.
					__(
						'Choose the form of international tax and duty settlement.%1$sLearn more about the %2$sdifference between DAP and DT1 (DDP) →%3$s',
						'woocommerce-dpd-uk'
					),
					'<br/>',
					'<a target="_blank" href="https://octol.io/dpd-uk-docs-tod">',
					'</a>'
				),
			],
			self::SETTING_INVOICE_VAT_NUMBER                  => [
				'title'       => __( 'Shipper\'s VAT Number', 'woocommerce-dpd-uk' ),
				'type'        => 'text',
				'class'       => 'dpd_uk_settings_invoice_details',
				'desc_tip'    => true,
				'description' => __(
					'Enter your GB VAT No. consisting of GB followed by 9 numerical digits, e.g. GB123456789. Only the GB registered VAT Numbers are allowed here - EU VAT Nos. are not.',
					'woocommerce-dpd-uk'
				),
			],
			self::SETTING_INVOICE_EORI_NUMBER                 => [
				'title'       => __( 'Shipper\'s EORI Number', 'woocommerce-dpd-uk' ),
				'type'        => 'text',
				'class'       => 'dpd_uk_settings_invoice_details',
				'desc_tip'    => true,
				'description' => __(
					'Enter your GB EORI No. consisting of GB followed by 12 numerical digits, e.g. GB123456789000. Only the GB registered EORIs are allowed here - EU EORIs are not. If not EORI-registered, type in GBUNREG.',
					'woocommerce-dpd-uk'
				),
				'default'     => 'GBUNREG',
			],
			self::SETTING_INVOICE_TYPE                        => [
			...
			[
				...
				'description' => __(
					'Products\' details are required to create international shipments.',
					'woocommerce-dpd-uk'
				),
			],
			self::SETTING_PRODUCT_COUNTRY_OF_ORIGIN_ATTRIBUTE => [
				...
				// Translators: docs link.
					__(
						'Select your products\' \'Country of Manufacture\' product attribute.%1$sDPD UK API accepts only the countries\' ISO codes as the products\'%2$s\'Country of Manufacture\' attribute\'s values.%3$sCheck %4$show to configure them properly →%5$s',
						'woocommerce-dpd-uk'
					),
					'<br/>',
					'<br/>',
					'<br/>',
					'<a target="_blank" href="https://octol.io/dpd-uk-docs-country">',
					'</a>'
				),
			],
			self::SETTING_PRODUCT_COUNTRY_OF_ORIGIN_DEFAULT   => [
				'title'       => __( 'Default Country of Manufacture', 'woocommerce-dpd-uk' ),
				'type'        => 'select',
				'class'       => 'dpd_uk_settings_product_details select2',
				'options'     => WC()->countries->get_countries(),
				'description' => __(
					'Country used by default when the product has no \'Country of Manufacture\' attribute assigned.',
					'woocommerce-dpd-uk'
				),
				'desc_tip'    => true,
			],
			self::SETTING_PRODUCT_HARMONISED_CODE_ATTRIBUTE   => [
				...
				'desc_tip'    => true,
				'description' => __(
					'Select your products\' \'Commodity Code\' product attribute.',
					'woocommerce-dpd-uk'
				),
			],
			self::SETTING_PRODUCT_HARMONISED_CODE_DEFAULT     => [
				'title'       => __( 'Default Commodity Code', 'woocommerce-dpd-uk' ),
				'type'        => 'text',
				'class'       => 'dpd_uk_settings_product_details',
				'description' => __(
					'Code used by default when the product has no \'Commodity Code\' attribute assigned.',
					'woocommerce-dpd-uk'
				),
				'desc_tip'    => true,
			],
			'woocommerce_dpd_uk_end'                          => [
				'type' => 'title',
			]
		];
	}
	...
	public function generate_connection_status_html( $key, $data ) {
		...
		ob_start();
		do_action( 'dpd-uk/settings/field/connection-status' );
