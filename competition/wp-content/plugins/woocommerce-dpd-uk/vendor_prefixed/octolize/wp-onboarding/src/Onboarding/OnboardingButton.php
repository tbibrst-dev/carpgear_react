...
class OnboardingButton implements \JsonSerializable
{
     ...
     */
    public function set_label(string $label) : \DpdUKVendor\Octolize\Onboarding\OnboardingButton
    {
        $this->label = $label;
        return $this;
    }
     ...
     * @return OnboardingButton
     */
    public function set_type(string $type) : \DpdUKVendor\Octolize\Onboarding\OnboardingButton
    {
        $this->type = $type;
        return $this;
    }
     ...
     * @return OnboardingButton
     */
    public function set_popup(string $popup) : \DpdUKVendor\Octolize\Onboarding\OnboardingButton
    {
        $this->popup = $popup;
        return $this;
    }
     ...
     * @return OnboardingButton
     */
    public function set_classes(string $classes) : \DpdUKVendor\Octolize\Onboarding\OnboardingButton
    {
