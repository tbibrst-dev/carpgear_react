 ...
 */
class PluginUpgradeWatcher implements \DpdUKVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    /**
     * @var string
     */
     ...
     */
    public function __construct(string $plugin_file_name, \DpdUKVendor\Octolize\Onboarding\OnboardingOption $onboarding_option)
    {
