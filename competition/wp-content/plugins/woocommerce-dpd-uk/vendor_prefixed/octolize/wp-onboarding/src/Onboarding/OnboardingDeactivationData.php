 ...
 */
class OnboardingDeactivationData implements \DpdUKVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
     ...
     */
    public function __construct(string $plugin_file, \DpdUKVendor\Octolize\Onboarding\OnboardingOption $onboarding_option)
    {
