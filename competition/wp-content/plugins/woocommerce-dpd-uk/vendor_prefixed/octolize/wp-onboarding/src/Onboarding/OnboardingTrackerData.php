 ...
 */
class OnboardingTrackerData implements \DpdUKVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    const PRIORITY = 1000;
    /**
     * @var string
     ...
     */
    public function __construct(string $append_data_to, \DpdUKVendor\Octolize\Onboarding\OnboardingOption $onboarding_option, $append_as = 'octolize_onboarding')
    {
