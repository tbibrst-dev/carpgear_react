...
class OnboardingStep implements \JsonSerializable
{
     ...
     */
    public function set_id(string $id) : \DpdUKVendor\Octolize\Onboarding\OnboardingStep
    {
        $this->id = $id;
        return $this;
    }
     ...
     * @return OnboardingStep
     */
    public function set_step(int $step) : \DpdUKVendor\Octolize\Onboarding\OnboardingStep
    {
        $this->step = $step;
        return $this;
    }
     ...
     * @return OnboardingStep
     */
    public function set_logo(bool $logo) : \DpdUKVendor\Octolize\Onboarding\OnboardingStep
    {
        $this->logo = $logo;
        return $this;
    }
     ...
     * @return OnboardingStep
     */
    public function set_title(string $title) : \DpdUKVendor\Octolize\Onboarding\OnboardingStep
    {
        $this->title = $title;
        return $this;
    }
     ...
     * @return OnboardingStep
     */
    public function set_show(bool $show) : \DpdUKVendor\Octolize\Onboarding\OnboardingStep
    {
        $this->show = $show;
        return $this;
    }
     ...
     * @return OnboardingStep
     */
    public function set_image(string $image) : \DpdUKVendor\Octolize\Onboarding\OnboardingStep
    {
        $this->image = $image;
        return $this;
    }
     ...
     * @return OnboardingStep
     */
    public function set_heading(string $heading) : \DpdUKVendor\Octolize\Onboarding\OnboardingStep
    {
     ...
     * @return OnboardingStep
     */
    public function set_sub_heading(string $sub_heading) : \DpdUKVendor\Octolize\Onboarding\OnboardingStep
    {
     ...
     * @return OnboardingStep
     */
    public function set_buttons(array $buttons) : \DpdUKVendor\Octolize\Onboarding\OnboardingStep
    {
        $this->buttons = $buttons;
        return $this;
    }
     ...
     * @return OnboardingStep
     */
    public function set_content(array $content) : \DpdUKVendor\Octolize\Onboarding\OnboardingStep
    {
        $this->content = $content;
        return $this;
    }
    ...
    private function serializeContent() : array
    {
        ...
        foreach ($this->content as $field) {
            ...
            if ($field instanceof \DpdUKVendor\WPDesk\Forms\Field\CheckboxField) {
