 ...
 */
class OptInNotice implements \DpdUKVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    /**
     * @var string
     */
     ...
     */
    public function __construct(string $plugin_slug, string $shop_url, \DpdUKVendor\Octolize\Tracker\OptInNotice\ShouldDisplay $should_display)
    {
    ...
    protected function create_notice()
    {
        ...
        new \DpdUKVendor\WPDesk\Notice\PermanentDismissibleNotice($this->prepare_notice_content(), $notice_name, \DpdUKVendor\WPDesk\Notice\Notice::NOTICE_TYPE_SUCCESS);
    }
    /**
     * @return string
     */
