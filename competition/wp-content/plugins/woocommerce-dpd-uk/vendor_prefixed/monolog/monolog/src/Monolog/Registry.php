...
class Registry
{
     ...
     * @return void
     */
    public static function addLogger(\DpdUKVendor\Monolog\Logger $logger, ?string $name = null, bool $overwrite = \false)
    {
     ...
     */
    public static function getInstance($name) : \DpdUKVendor\Monolog\Logger
    {
