...
class CubeHandler extends \DpdUKVendor\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct(string $url, $level = \DpdUKVendor\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
    ...
    protected function connectHttp() : void
    {
        if (!\extension_loaded('curl')) {
            throw new \DpdUKVendor\Monolog\Handler\MissingExtensionException('The curl extension is required to use http URLs with the CubeHandler');
        }
