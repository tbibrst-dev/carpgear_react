...
class MongoDBFormatter implements \DpdUKVendor\Monolog\Formatter\FormatterInterface
{
    ...
    {
        $formattedException = ['class' => \DpdUKVendor\Monolog\Utils::getClass($exception), 'message' => $exception->getMessage(), 'code' => (int) $exception->getCode(), 'file' => $exception->getFile() . ':' . $exception->getLine()];
