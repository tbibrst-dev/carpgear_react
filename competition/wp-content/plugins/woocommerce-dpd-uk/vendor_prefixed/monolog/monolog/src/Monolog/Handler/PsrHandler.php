 ...
 */
class PsrHandler extends \DpdUKVendor\Monolog\Handler\AbstractHandler implements \DpdUKVendor\Monolog\Handler\FormattableHandlerInterface
{
    /**
     ...
     */
    public function __construct(\DpdUKVendor\Psr\Log\LoggerInterface $logger, $level = \DpdUKVendor\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
