...
use DpdUKVendor\PhpConsole\Handler as VendorPhpConsoleHandler;
...
class PHPConsoleHandler extends \DpdUKVendor\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct(array $options = [], ?\DpdUKVendor\PhpConsole\Connector $connector = null, $level = \DpdUKVendor\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
    ...
    private function initConnector(?\DpdUKVendor\PhpConsole\Connector $connector = null) : \DpdUKVendor\PhpConsole\Connector
    {
        if (!$connector) {
    ...
    public function getConnector() : \DpdUKVendor\PhpConsole\Connector
    {
