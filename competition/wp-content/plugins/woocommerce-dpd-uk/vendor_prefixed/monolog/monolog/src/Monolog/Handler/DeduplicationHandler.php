...
class DeduplicationHandler extends \DpdUKVendor\Monolog\Handler\BufferHandler
{
     ...
     */
    public function __construct(\DpdUKVendor\Monolog\Handler\HandlerInterface $handler, ?string $deduplicationStore = null, $deduplicationLevel = \DpdUKVendor\Monolog\Logger::ERROR, int $time = 60, bool $bubble = \true)
    {
