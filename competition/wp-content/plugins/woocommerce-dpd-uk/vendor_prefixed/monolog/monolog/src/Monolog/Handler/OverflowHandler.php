 ...
 */
class OverflowHandler extends \DpdUKVendor\Monolog\Handler\AbstractHandler implements \DpdUKVendor\Monolog\Handler\FormattableHandlerInterface
{
    /** @var HandlerInterface */
    private $handler;
    /** @var int[] */
    private $thresholdMap = [\DpdUKVendor\Monolog\Logger::DEBUG => 0, \DpdUKVendor\Monolog\Logger::INFO => 0, \DpdUKVendor\Monolog\Logger::NOTICE => 0, \DpdUKVendor\Monolog\Logger::WARNING => 0, \DpdUKVendor\Monolog\Logger::ERROR => 0, \DpdUKVendor\Monolog\Logger::CRITICAL => 0, \DpdUKVendor\Monolog\Logger::ALERT => 0, \DpdUKVendor\Monolog\Logger::EMERGENCY => 0];
    /**
     ...
     */
    public function __construct(\DpdUKVendor\Monolog\Handler\HandlerInterface $handler, array $thresholdMap = [], $level = \DpdUKVendor\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
