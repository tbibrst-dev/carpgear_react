...
class SlackRecord
{
     ...
     */
    public function __construct(?string $channel = null, ?string $username = null, bool $useAttachment = \true, ?string $userIcon = null, bool $useShortAttachment = \false, bool $includeContextAndExtra = \false, array $excludeFields = array(), \DpdUKVendor\Monolog\Formatter\FormatterInterface $formatter = null)
    {
    ...
    public function stringify(array $fields) : string
    {
        ...
        return $hasSecondDimension || $hasNonNumericKeys ? \DpdUKVendor\Monolog\Utils::jsonEncode($normalized, \JSON_PRETTY_PRINT | \DpdUKVendor\Monolog\Utils::DEFAULT_JSON_FLAGS) : \DpdUKVendor\Monolog\Utils::jsonEncode($normalized, \DpdUKVendor\Monolog\Utils::DEFAULT_JSON_FLAGS);
    }
    /**
    ...
    public function setFormatter(?\DpdUKVendor\Monolog\Formatter\FormatterInterface $formatter = null) : self
    {
