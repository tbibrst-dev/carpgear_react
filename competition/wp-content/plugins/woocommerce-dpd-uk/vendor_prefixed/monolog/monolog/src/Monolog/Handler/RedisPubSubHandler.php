 ...
 */
class RedisPubSubHandler extends \DpdUKVendor\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct($redis, string $key, $level = \DpdUKVendor\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
