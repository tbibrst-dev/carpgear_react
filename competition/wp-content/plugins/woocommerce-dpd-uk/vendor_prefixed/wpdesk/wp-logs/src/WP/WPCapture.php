...
class WPCapture
{
    ...
    private function add_notice_for_dir($dir)
    {
        new \DpdUKVendor\WPDesk\Notice\Notice(\sprintf(
            ...
            \__('Can not enable WP Desk Debug log! Cannot create directory %s or this directory is not writeable!', 'woocommerce-dpd-uk'),
            $dir
    ...
    private function add_notice_for_file($file)
    {
        new \DpdUKVendor\WPDesk\Notice\Notice(\sprintf(
            // Translators: directory.
            \__('Can not enable WP Desk Debug log! Cannot create file %s!', 'woocommerce-dpd-uk'),
            $file
        ), \DpdUKVendor\WPDesk\Notice\Notice::NOTICE_TYPE_ERROR);
    }
    /**
