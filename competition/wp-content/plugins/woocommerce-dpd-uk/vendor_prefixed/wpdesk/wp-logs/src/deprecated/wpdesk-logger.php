...
if (!\class_exists('DpdUKVendor\\WPDesk_Logger')) {
    ...
    class WPDesk_Logger
    {
        ...
        {
            return ['disabled' => \__('Disabled', 'woocommerce-dpd-uk'), 'emergency' => \__('Emergency', 'woocommerce-dpd-uk'), 'alert' => \__('Alert', 'woocommerce-dpd-uk'), 'critical' => \__('Critical', 'woocommerce-dpd-uk'), 'error' => \__('Error', 'woocommerce-dpd-uk'), 'warning' => \__('Warning', 'woocommerce-dpd-uk'), 'notice' => \__('Notice', 'woocommerce-dpd-uk'), 'info' => \__('Info', 'woocommerce-dpd-uk'), 'debug' => \__('Debug', 'woocommerce-dpd-uk')];
        }
        /**
         * @param string $level
         * @param string $source
