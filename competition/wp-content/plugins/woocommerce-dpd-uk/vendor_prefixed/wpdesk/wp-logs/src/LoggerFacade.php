...
class LoggerFacade
{
     ...
     */
    public static function log_wp_error(\WP_Error $e, array $backtrace, array $context = array(), $level = \DpdUKVendor\Psr\Log\LogLevel::ERROR)
    {
     ...
     * @param string $level Level of error.
     */
    public static function log_exception(\Exception $e, array $context = array(), $level = \DpdUKVendor\Psr\Log\LogLevel::ERROR)
    {
     ...
     * @param string $level Level of error.
     */
    public static function log_message($message, array $context = array(), $source = null, $level = \DpdUKVendor\Psr\Log\LogLevel::DEBUG)
    {
     ...
     * @param string $level Level of error.
     */
    public static function log_message_backtrace($message, array $backtrace, array $context = array(), $level = \DpdUKVendor\Psr\Log\LogLevel::DEBUG)
    {
