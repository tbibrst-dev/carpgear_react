 ...
 */
class LicenseActivation extends \DpdUKVendor\WPDesk\License\Page\License\Action\AbstractAction implements \DpdUKVendor\WPDesk\License\Page\Action
{
    /**
     * Plugin data.
     *
    ...
    {
        $this->add_error('api_key_check_text', 'api_key_check_error', \__('Connection failed to the Subscription Key API server. Try again later.', 'woocommerce-dpd-uk'), 'error');
    }
    /**
    ...
    {
        $this->add_error('activate_text', 'activate_msg', \__('Plugin license activated. ', 'woocommerce-dpd-uk') . "{$activate_results['message']}.", 'updated');
    }
    /**
     * Activate license.
     *
