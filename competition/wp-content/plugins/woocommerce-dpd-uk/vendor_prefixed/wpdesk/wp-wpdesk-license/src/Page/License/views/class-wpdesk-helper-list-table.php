...
class WPDesk_Helper_List_Table extends \WP_List_Table
{
    ...
    {
        echo \wpautop(\__('No WP Desk plugins found.', 'woocommerce-dpd-uk'));
    }
    ...
    {
        $columns = ['product_name' => \__('Plugin', 'woocommerce-dpd-uk'), 'product_status' => \__('Subscription Status', 'woocommerce-dpd-uk'), 'product_license' => \__('Subscription Data', 'woocommerce-dpd-uk')];
        return $columns;
    }
    ...
    {
        $status = \__('Deactivated', 'woocommerce-dpd-uk');
        if ($item['activation_status'] == 'Activated') {
            $status = \__('Activated', 'woocommerce-dpd-uk');
        }
        return $status;
    }
