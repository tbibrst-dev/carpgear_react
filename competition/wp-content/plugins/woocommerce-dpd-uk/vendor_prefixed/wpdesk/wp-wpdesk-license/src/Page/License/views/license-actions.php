...
<form method="POST">
    <table class="wpdesk_helper_key_table">
        <tr>
            <td><?php 
\esc_html(\__('Key:', 'woocommerce-dpd-uk'));
?></td>
...
?> /></td>
        ...
        <tr>
            <td><?php 
\esc_html(\__('Email:', 'woocommerce-dpd-uk'));
?></td>
...
if ($activation_status == 'Deactivated') {
    ...
    echo \esc_html(\__('Activate', 'woocommerce-dpd-uk'));
    ?></button>
				<?php 
} else {
    ?>
                    <button class="wpdesk_helper_button button"><?php 
    echo \esc_html(\__('Deactivate', 'woocommerce-dpd-uk'));
    ?></button>
				<?php 
}
?>
