...
class Renderer
{
     ...
     */
    public function __construct(\DpdUKVendor\WPDesk_Plugin_Info $plugin_info, bool $update_possible)
    {
    ...
    {
        $form_content = new \DpdUKVendor\WPDesk\License\ActivationForm\FormContentRenderer($this->plugin_info, $this->update_possible);
