...
class LicensePage implements \DpdUKVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    ...
    {
        \add_submenu_page('wpdesk-helper', \__('Subscriptions', 'woocommerce-dpd-uk'), \__('Subscriptions', 'woocommerce-dpd-uk'), 'manage_options', self::PAGE_SLUG, [$this, 'handle_render_wpdesk_licenses_page']);
    }
    /**
