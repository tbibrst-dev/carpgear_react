...
namespace DpdUKVendor\WPDesk\License\ActivationForm;

use DpdUKVendor\WPDesk\License\LicenseManager;
use DpdUKVendor\WPDesk\License\Page\LicensePageActions;
use DpdUKVendor\WPDesk\License\PluginLicense;
 ...
 */
class AjaxHandler implements \DpdUKVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    ...
    public function handle_ajax_action()
    {
        ...
        $license_page_action = (new \DpdUKVendor\WPDesk\License\Page\LicensePageActions())->create_action($license_action, \false);
        ...
        $plugin_license = new \DpdUKVendor\WPDesk\License\PluginLicense($this->plugin_info);
        $form_content_renderer = new \DpdUKVendor\WPDesk\License\ActivationForm\FormContentRenderer($this->plugin_info, $this->is_update_possible(isset($update_plugins[$this->plugin_info->get_plugin_file_name()]) ?? new \stdClass()), $license_page_action->get_errors());
