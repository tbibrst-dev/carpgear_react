...
?>">
			<?php 
\esc_html_e('Set image', 'woocommerce-dpd-uk');
?>
		</a>
...
?>" href="#">
			<?php 
\esc_html_e('Remove image', 'woocommerce-dpd-uk');
?>
		</a>
	</p>
</div>
...
?>' ),
		...
		addImgLink.on( 'click', function ( event ) {
			...
			frame = wp.media( {
				title: "<?php 
\esc_html_e('Select or Upload Media', 'woocommerce-dpd-uk');
?>",
				button: {
					text: "<?php 
\esc_html_e('Use this media', 'woocommerce-dpd-uk');
?>"
				},
				library: {
					type: ['image']
