...
use DpdUKVendor\WPDesk\Forms\Sanitizer\NoSanitize;
use DpdUKVendor\WPDesk\Forms\Serializer;
use DpdUKVendor\WPDesk\Forms\Validator;
use DpdUKVendor\WPDesk\Forms\Validator\ChainValidator;
use DpdUKVendor\WPDesk\Forms\Validator\RequiredValidator;
/**
 * Base class for fields. Is responsible for settings all required field values and provides standard implementation for
 * the field interface.
 */
abstract class BasicField implements \DpdUKVendor\WPDesk\Forms\Field
{
    ...
    public function set_type(string $type) : \DpdUKVendor\WPDesk\Forms\Field
    {
        $this->meta['type'] = $type;
        return $this;
    }
    ...
    {
        $chain = new \DpdUKVendor\WPDesk\Forms\Validator\ChainValidator();
        if ($this->is_required()) {
            $chain->attach(new \DpdUKVendor\WPDesk\Forms\Validator\RequiredValidator());
        }
        return $chain;
    }
    public function get_sanitizer() : \DpdUKVendor\WPDesk\Forms\Sanitizer
    {
        return new \DpdUKVendor\WPDesk\Forms\Sanitizer\NoSanitize();
    }
    ...
    public final function set_label(string $value) : \DpdUKVendor\WPDesk\Forms\Field
    {
    ...
    public final function set_description(string $value) : \DpdUKVendor\WPDesk\Forms\Field
    {
        $this->meta['description'] = $value;
        return $this;
    }
    public final function set_description_tip(string $value) : \DpdUKVendor\WPDesk\Forms\Field
    {
        $this->meta['description_tip'] = $value;
        return $this;
    }
    public final function set_placeholder(string $value) : \DpdUKVendor\WPDesk\Forms\Field
    {
    ...
    public final function set_name(string $name) : \DpdUKVendor\WPDesk\Forms\Field
    {
    ...
    public final function set_disabled() : \DpdUKVendor\WPDesk\Forms\Field
    {
    ...
    public final function set_readonly() : \DpdUKVendor\WPDesk\Forms\Field
    {
    ...
    public final function set_required() : \DpdUKVendor\WPDesk\Forms\Field
    {
        $this->attributes['required'] = 'required';
        return $this;
    }
    public final function add_class(string $class_name) : \DpdUKVendor\WPDesk\Forms\Field
    {
        $this->attributes['class'][$class_name] = $class_name;
        return $this;
    }
    public final function unset_class(string $class_name) : \DpdUKVendor\WPDesk\Forms\Field
    {
        unset($this->attributes['class'][$class_name]);
        return $this;
    }
    public final function add_data(string $data_name, string $data_value) : \DpdUKVendor\WPDesk\Forms\Field
    {
    ...
    public final function unset_data(string $data_name) : \DpdUKVendor\WPDesk\Forms\Field
    {
    ...
    public final function set_default_value(string $value) : \DpdUKVendor\WPDesk\Forms\Field
    {
     ...
     */
    public final function set_priority(int $priority) : \DpdUKVendor\WPDesk\Forms\Field
    {
