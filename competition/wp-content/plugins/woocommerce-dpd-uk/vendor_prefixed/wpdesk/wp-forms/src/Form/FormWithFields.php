...
class FormWithFields implements \DpdUKVendor\WPDesk\Forms\Form, \DpdUKVendor\WPDesk\Forms\ContainerForm, \DpdUKVendor\WPDesk\Forms\FieldProvider
{
    ...
    /** @return void */
    public function add_field(\DpdUKVendor\WPDesk\Forms\Field $field)
    {
        $this->fields[] = $field;
    }
    ...
    public function set_data(\DpdUKVendor\Psr\Container\ContainerInterface $data)
    {
        foreach ($this->fields as $field) {
            ...
            if ($data->has($data_key)) {
                ...
                } catch (\DpdUKVendor\WPDesk\Persistence\ElementNotExistsException $e) {
    ...
    public function render_fields(\DpdUKVendor\WPDesk\View\Renderer\Renderer $renderer) : string
    {
        $content = '';
    ...
    public function render_form(\DpdUKVendor\WPDesk\View\Renderer\Renderer $renderer) : string
    {
    ...
    {
        $fields = $this->fields;
        \usort($fields, static function (\DpdUKVendor\WPDesk\Forms\Field $a, \DpdUKVendor\WPDesk\Forms\Field $b) {
