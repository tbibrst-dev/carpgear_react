...
namespace DpdUKVendor\WPDesk\Forms\Renderer;

use DpdUKVendor\WPDesk\Forms\Field;
use DpdUKVendor\WPDesk\Forms\FieldProvider;
use DpdUKVendor\WPDesk\Forms\FieldRenderer;
/**
 * Can render form fields as JSON.
 *
 * @package WPDesk\Forms\Renderer
 */
class JsonNormalizedRenderer implements \DpdUKVendor\WPDesk\Forms\FieldRenderer
{
    /**
     ...
     */
    public function render_fields(\DpdUKVendor\WPDesk\Forms\FieldProvider $provider, array $fields_data, string $name_prefix = '') : array
    {
        $rendered_fields = [];
