...
namespace DpdUKVendor\WPDesk\Persistence\Adapter\WordPress;
 ...
 */
final class WordpressPostMetaContainer implements \DpdUKVendor\WPDesk\Persistence\PersistentContainer
{
    ...
    public function get($key)
    {
        ...
        if (\count($meta) === 0) {
            throw new \DpdUKVendor\WPDesk\Persistence\ElementNotExistsException(\sprintf('Element %s not exists!', $key));
        }
        return $meta[0];
    }
    /**
