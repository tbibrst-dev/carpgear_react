 ...
 * .
 */
class PageViewTracker implements \FPrintingVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    use AdminPage;
    /**
     * @var ViewPageTracker
    ...
    public function view_tracking() : void
    {
        ...
        if (isset($_GET[\FPrintingVendor\Octolize\ShippingExtensions\PluginLinks::PLUGIN_LINKS_PAGE])) {
