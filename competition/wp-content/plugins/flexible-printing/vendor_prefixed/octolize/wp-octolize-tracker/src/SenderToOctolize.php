...
class SenderToOctolize implements \WPDesk_Tracker_Sender
{
    ...
    {
        \FPrintingVendor\WPDesk_Logger_Factory::log_message("Target URL: " . $this->get_api_url(), 'octolize-sender', \FPrintingVendor\WPDesk_Logger::DEBUG);
        ...
        if ($response instanceof \WP_Error) {
            throw new \FPrintingVendor\WPDesk_Tracker_Sender_Exception_WpError('Payload send error', $response);
        } else {
            return $response;
        }
    }
