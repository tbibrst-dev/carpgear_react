 ...
 */
class OptInNotice implements \FPrintingVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    /**
     * @var string
     */
     ...
     */
    public function __construct(string $plugin_slug, string $shop_url, \FPrintingVendor\Octolize\Tracker\OptInNotice\ShouldDisplay $should_display)
    {
    ...
    protected function create_notice()
    {
        ...
        new \FPrintingVendor\WPDesk\Notice\PermanentDismissibleNotice($this->prepare_notice_content(), $notice_name, \FPrintingVendor\WPDesk\Notice\Notice::NOTICE_TYPE_SUCCESS);
    }
    /**
     * @return string
     */
