 ...
 */
class InfoBuilder extends \FPrintingVendor\WPDesk\PluginBuilder\Builder\AbstractBuilder
{
    ...
    public function __construct(\FPrintingVendor\WPDesk_Buildable $info)
    {
        $this->info = $info;
