...
if (!\interface_exists('FPrintingVendor\\WPDesk_Buildable')) {
    require_once __DIR__ . '/Buildable.php';
}
if (!\interface_exists('FPrintingVendor\\WPDesk_Has_Plugin_Info')) {
 ...
 */
class WPDesk_Plugin_Info implements \FPrintingVendor\WPDesk_Translatable, \FPrintingVendor\WPDesk_Buildable, \FPrintingVendor\WPDesk_Has_Plugin_Info
{
    /** @var string */
