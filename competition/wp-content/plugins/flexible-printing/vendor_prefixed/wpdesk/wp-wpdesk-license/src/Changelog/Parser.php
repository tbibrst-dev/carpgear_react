...
namespace FPrintingVendor\WPDesk\License\Changelog;

use ArrayObject;
use FPrintingVendor\WPDesk\License\Changelog\Parser\Line;
/**
 * Can parse changelog.
 *
...
class Parser
{
    ...
    private function get_lines()
    {
        ...
        return \array_map(function ($line) {
            return new \FPrintingVendor\WPDesk\License\Changelog\Parser\Line($line);
