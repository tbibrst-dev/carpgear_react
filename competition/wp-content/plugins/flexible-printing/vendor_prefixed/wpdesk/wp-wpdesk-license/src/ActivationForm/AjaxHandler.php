...
use FPrintingVendor\WPDesk\License\LicenseManager;
use FPrintingVendor\WPDesk\License\Page\LicensePageActions;
use FPrintingVendor\WPDesk\License\PluginLicense;
 ...
 */
class AjaxHandler implements \FPrintingVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    ...
    public function handle_ajax_action()
    {
        ...
        $license_manager = new \FPrintingVendor\WPDesk\License\LicenseManager($this->plugin_info);
        ...
        $license_page_action = (new \FPrintingVendor\WPDesk\License\Page\LicensePageActions())->create_action($license_action, \false);
        ...
        $plugin_license = new \FPrintingVendor\WPDesk\License\PluginLicense($this->plugin_info);
        $form_content_renderer = new \FPrintingVendor\WPDesk\License\ActivationForm\FormContentRenderer($this->plugin_info, $this->is_update_possible(isset($update_plugins[$this->plugin_info->get_plugin_file_name()]) ?? new \stdClass()), $license_page_action->get_errors());
