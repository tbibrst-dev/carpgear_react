 ...
 */
class LicenseDeactivation extends \FPrintingVendor\WPDesk\License\Page\License\Action\AbstractAction implements \FPrintingVendor\WPDesk\License\Page\Action
{
    /**
    ...
    public function execute(array $plugin)
    {
        ...
        if ($activate_results['deactivated'] === \true) {
            ...
            $this->add_error('wc_am_deactivate_text', 'deactivate_msg', \__('Plugin license deactivated. ', 'flexible-printing') . "{$activate_results['activations_remaining']}.", 'updated');
            $deactivated = \true;
