 ...
 */
class OldLicenseRegistrator implements \FPrintingVendor\WPDesk\License\PluginRegistratorInterface
{
    ...
    public function __construct(\FPrintingVendor\WPDesk_Plugin_Info $plugin_info)
    {
        ...
        $this->plugin_license = new \FPrintingVendor\WPDesk\License\PluginLicense($plugin_info);
    }
