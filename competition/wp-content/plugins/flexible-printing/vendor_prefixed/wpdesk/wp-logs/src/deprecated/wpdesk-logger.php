...
if (!\class_exists('FPrintingVendor\\WPDesk_Logger')) {
    /**
    ...
    class WPDesk_Logger
    {
        ...
        {
            if (!self::$logger) {
                $loggerFactroy = new \FPrintingVendor\WPDesk\Logger\WPDeskLoggerFactory();
        ...
        {
            return ['disabled' => \__('Disabled', 'flexible-printing'), 'emergency' => \__('Emergency', 'flexible-printing'), 'alert' => \__('Alert', 'flexible-printing'), 'critical' => \__('Critical', 'flexible-printing'), 'error' => \__('Error', 'flexible-printing'), 'warning' => \__('Warning', 'flexible-printing'), 'notice' => \__('Notice', 'flexible-printing'), 'info' => \__('Info', 'flexible-printing'), 'debug' => \__('Debug', 'flexible-printing')];
        }
        /**
         * @param string $level
         * @param string $source
