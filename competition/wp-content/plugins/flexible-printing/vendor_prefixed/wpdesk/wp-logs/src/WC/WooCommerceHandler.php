...
use FPrintingVendor\Monolog\Handler\AbstractProcessingHandler;
use FPrintingVendor\Monolog\Logger;
/**
 * Class WooCommerceFactory
 */
class WooCommerceHandler extends \FPrintingVendor\Monolog\Handler\AbstractProcessingHandler
{
    ...
    {
        return \FPrintingVendor\Monolog\Logger::getLevelName($level);
    }
