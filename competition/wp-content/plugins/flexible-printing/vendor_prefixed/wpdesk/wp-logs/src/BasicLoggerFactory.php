 ...
 */
class BasicLoggerFactory implements \FPrintingVendor\WPDesk\Logger\LoggerFactory
{
    ...
    public function createLogger($name, $handlers = array(), array $processors = array())
    {
        ...
        $logger = new \FPrintingVendor\Monolog\Logger($name, $handlers, $processors);
        \FPrintingVendor\Monolog\Registry::addLogger($logger);
        return $logger;
    }
    /**
