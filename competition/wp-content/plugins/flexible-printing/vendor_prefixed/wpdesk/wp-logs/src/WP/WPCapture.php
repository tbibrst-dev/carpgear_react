...
namespace FPrintingVendor\WPDesk\Logger\WP;
...
class WPCapture
{
    ...
    {
        new \FPrintingVendor\WPDesk\Notice\Notice(\sprintf(
            // Translators: directory.
            \__('Can not enable WP Desk Debug log! Cannot create directory %s or this directory is not writeable!', 'flexible-printing'),
            $dir
        ), \FPrintingVendor\WPDesk\Notice\Notice::NOTICE_TYPE_ERROR);
    }
    /**
     * Add notice for file.
     *
    ...
    private function add_notice_for_file($file)
    {
        new \FPrintingVendor\WPDesk\Notice\Notice(\sprintf(
            // Translators: directory.
            \__('Can not enable WP Desk Debug log! Cannot create file %s!', 'flexible-printing'),
            $file
        ), \FPrintingVendor\WPDesk\Notice\Notice::NOTICE_TYPE_ERROR);
    }
    /**
