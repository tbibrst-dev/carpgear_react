 ...
 */
class SimplePhpRenderer implements \FPrintingVendor\WPDesk\View\Renderer\Renderer
{
    /** @var Resolver */
    private $resolver;
    public function __construct(\FPrintingVendor\WPDesk\View\Resolver\Resolver $resolver)
    {
