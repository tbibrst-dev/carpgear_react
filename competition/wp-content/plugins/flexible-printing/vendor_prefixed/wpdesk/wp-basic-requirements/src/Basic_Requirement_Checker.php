...
if (!\interface_exists('FPrintingVendor\\WPDesk_Requirement_Checker')) {
...
if (!\class_exists('FPrintingVendor\\WPDesk_Basic_Requirement_Checker')) {
     ...
     */
    class WPDesk_Basic_Requirement_Checker implements \FPrintingVendor\WPDesk_Requirement_Checker
    {
