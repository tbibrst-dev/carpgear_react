 ...
 */
class RedisPubSubHandler extends \FPrintingVendor\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct($redis, string $key, $level = \FPrintingVendor\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
