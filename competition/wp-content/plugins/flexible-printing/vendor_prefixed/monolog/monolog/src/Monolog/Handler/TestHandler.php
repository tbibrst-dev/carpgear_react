 ...
 */
class TestHandler extends \FPrintingVendor\Monolog\Handler\AbstractProcessingHandler
{
    /** @var Record[] */
    protected $records = [];
    ...
    {
        return isset($this->recordsByLevel[\FPrintingVendor\Monolog\Logger::toMonologLevel($level)]);
    }
    /**
    ...
    {
        $level = \FPrintingVendor\Monolog\Logger::toMonologLevel($level);
