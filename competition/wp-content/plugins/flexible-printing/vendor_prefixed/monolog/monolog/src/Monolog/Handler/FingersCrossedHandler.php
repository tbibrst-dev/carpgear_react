...
use FPrintingVendor\Monolog\Handler\FingersCrossed\ErrorLevelActivationStrategy;
use FPrintingVendor\Monolog\Handler\FingersCrossed\ActivationStrategyInterface;
 ...
 */
class FingersCrossedHandler extends \FPrintingVendor\Monolog\Handler\Handler implements \FPrintingVendor\Monolog\Handler\ProcessableHandlerInterface, \FPrintingVendor\Monolog\ResettableInterface, \FPrintingVendor\Monolog\Handler\FormattableHandlerInterface
{
    ...
    public function __construct($handler, $activationStrategy = null, int $bufferSize = 0, bool $bubble = \true, bool $stopBuffering = \true, $passthruLevel = null)
    {
        if (null === $activationStrategy) {
            $activationStrategy = new \FPrintingVendor\Monolog\Handler\FingersCrossed\ErrorLevelActivationStrategy(\FPrintingVendor\Monolog\Logger::WARNING);
        }
        // convert simple int activationStrategy to an object
        if (!$activationStrategy instanceof \FPrintingVendor\Monolog\Handler\FingersCrossed\ActivationStrategyInterface) {
            $activationStrategy = new \FPrintingVendor\Monolog\Handler\FingersCrossed\ErrorLevelActivationStrategy($activationStrategy);
        }
        ...
        if ($passthruLevel !== null) {
            $this->passthruLevel = \FPrintingVendor\Monolog\Logger::toMonologLevel($passthruLevel);
        }
        if (!$this->handler instanceof \FPrintingVendor\Monolog\Handler\HandlerInterface && !\is_callable($this->handler)) {
    ...
    public function reset()
    {
        ...
        if ($this->getHandler() instanceof \FPrintingVendor\Monolog\ResettableInterface) {
    ...
    {
        if (!$this->handler instanceof \FPrintingVendor\Monolog\Handler\HandlerInterface) {
