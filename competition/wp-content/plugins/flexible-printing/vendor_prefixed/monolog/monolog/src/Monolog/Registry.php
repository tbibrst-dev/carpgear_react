...
class Registry
{
     ...
     * @return void
     */
    public static function addLogger(\FPrintingVendor\Monolog\Logger $logger, ?string $name = null, bool $overwrite = \false)
    {
    ...
    {
        if ($logger instanceof \FPrintingVendor\Monolog\Logger) {
     ...
     */
    public static function getInstance($name) : \FPrintingVendor\Monolog\Logger
    {
