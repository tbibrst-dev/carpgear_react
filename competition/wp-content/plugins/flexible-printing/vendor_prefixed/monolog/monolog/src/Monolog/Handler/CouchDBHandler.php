 ...
 */
class CouchDBHandler extends \FPrintingVendor\Monolog\Handler\AbstractProcessingHandler
{
    /** @var mixed[] */
    private $options;
    /**
     * @param mixed[] $options
     */
    public function __construct(array $options = [], $level = \FPrintingVendor\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
