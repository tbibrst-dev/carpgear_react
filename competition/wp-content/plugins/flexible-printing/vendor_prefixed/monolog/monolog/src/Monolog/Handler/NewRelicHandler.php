 ...
 */
class NewRelicHandler extends \FPrintingVendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
     ...
     */
    public function __construct($level = \FPrintingVendor\Monolog\Logger::ERROR, bool $bubble = \true, ?string $appName = null, bool $explodeArrays = \false, ?string $transactionName = null)
    {
    ...
    protected function write(array $record) : void
    {
        if (!$this->isNewRelicEnabled()) {
            throw new \FPrintingVendor\Monolog\Handler\MissingExtensionException('The newrelic PHP extension is required to use the NewRelicHandler');
        }
    ...
    protected function setNewRelicParameter(string $key, $value) : void
    {
        if (null === $value || \is_scalar($value)) {
            ...
            \newrelic_add_custom_parameter($key, \FPrintingVendor\Monolog\Utils::jsonEncode($value, null, \true));
        }
    }
    /**
     * {@inheritDoc}
