 ...
 */
class DeduplicationHandler extends \FPrintingVendor\Monolog\Handler\BufferHandler
{
    /**
     * @var string
     */
     ...
     */
    public function __construct(\FPrintingVendor\Monolog\Handler\HandlerInterface $handler, ?string $deduplicationStore = null, $deduplicationLevel = \FPrintingVendor\Monolog\Logger::ERROR, int $time = 60, bool $bubble = \true)
    {
        parent::__construct($handler, 0, \FPrintingVendor\Monolog\Logger::DEBUG, $bubble, \false);
        $this->deduplicationStore = $deduplicationStore === null ? \sys_get_temp_dir() . '/monolog-dedup-' . \substr(\md5(__FILE__), 0, 20) . '.log' : $deduplicationStore;
        $this->deduplicationLevel = \FPrintingVendor\Monolog\Logger::toMonologLevel($deduplicationLevel);
        $this->time = $time;
    }
