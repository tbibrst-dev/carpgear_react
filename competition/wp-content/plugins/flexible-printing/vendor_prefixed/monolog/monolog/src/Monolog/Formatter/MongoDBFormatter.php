 ...
 */
class MongoDBFormatter implements \FPrintingVendor\Monolog\Formatter\FormatterInterface
{
    /** @var bool */
    ...
    protected function formatObject($value, int $nestingLevel)
    {
        ...
        $objectVars['class'] = \FPrintingVendor\Monolog\Utils::getClass($value);
    ...
    {
        $formattedException = ['class' => \FPrintingVendor\Monolog\Utils::getClass($exception), 'message' => $exception->getMessage(), 'code' => (int) $exception->getCode(), 'file' => $exception->getFile() . ':' . $exception->getLine()];
