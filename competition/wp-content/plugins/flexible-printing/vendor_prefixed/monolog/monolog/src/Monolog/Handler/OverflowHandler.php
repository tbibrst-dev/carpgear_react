 ...
 */
class OverflowHandler extends \FPrintingVendor\Monolog\Handler\AbstractHandler implements \FPrintingVendor\Monolog\Handler\FormattableHandlerInterface
{
    /** @var HandlerInterface */
    private $handler;
    /** @var int[] */
    private $thresholdMap = [\FPrintingVendor\Monolog\Logger::DEBUG => 0, \FPrintingVendor\Monolog\Logger::INFO => 0, \FPrintingVendor\Monolog\Logger::NOTICE => 0, \FPrintingVendor\Monolog\Logger::WARNING => 0, \FPrintingVendor\Monolog\Logger::ERROR => 0, \FPrintingVendor\Monolog\Logger::CRITICAL => 0, \FPrintingVendor\Monolog\Logger::ALERT => 0, \FPrintingVendor\Monolog\Logger::EMERGENCY => 0];
    /**
     ...
     */
    public function __construct(\FPrintingVendor\Monolog\Handler\HandlerInterface $handler, array $thresholdMap = [], $level = \FPrintingVendor\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
