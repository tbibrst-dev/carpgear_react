 ...
 */
class PsrHandler extends \FPrintingVendor\Monolog\Handler\AbstractHandler implements \FPrintingVendor\Monolog\Handler\FormattableHandlerInterface
{
    /**
     ...
     */
    public function __construct(\Psr\Log\LoggerInterface $logger, $level = \FPrintingVendor\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
