 ...
 */
class RotatingFileHandler extends \FPrintingVendor\Monolog\Handler\StreamHandler
{
     ...
     */
    public function __construct(string $filename, int $maxFiles = 0, $level = \FPrintingVendor\Monolog\Logger::DEBUG, bool $bubble = \true, ?int $filePermission = null, bool $useLocking = \false)
    {
        $this->filename = \FPrintingVendor\Monolog\Utils::canonicalizePath($filename);
