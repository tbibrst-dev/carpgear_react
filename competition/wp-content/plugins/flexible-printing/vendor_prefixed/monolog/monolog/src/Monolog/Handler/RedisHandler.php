 ...
 */
class RedisHandler extends \FPrintingVendor\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct($redis, string $key, $level = \FPrintingVendor\Monolog\Logger::DEBUG, bool $bubble = \true, int $capSize = 0)
    {
        if (!($redis instanceof \FPrintingVendor\Predis\Client || $redis instanceof \Redis)) {
    ...
    {
        return new \FPrintingVendor\Monolog\Formatter\LineFormatter();
    }
}
