		...
		.on('country_to_state_changing', function (event, country, wrapper) {
			...
			$.each(locale_fields, function (key, value) {
				...
				if (Array.isArray(fieldLocale.class)) {
					...
					if ("billing_city_fieldd" == field.attr("id") || "billing_state_field" == field.attr("id") || "shipping_state_field" == field.attr("id")) {
						field.addClass("form-row-first");
						field.removeClass("form-row-wide");
					}
					if ("billing_postcode_field" == field.attr("id") || "shipping_postcode_field" == field.attr("id")) {
						field.addClass("form-row-last");
						field.removeClass("form-row-wide");
					}
				}
			});
