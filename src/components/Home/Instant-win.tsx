...
const CACHE_KEY = "instantWinCompetitions";
...
const InstantWins = () => {
  ...
  // handle quantity change of a competition
  ...
  return (
    <Element name="instant-win-section-scroll" >

    <div id="instant-wins " className="instant_win_section" >
      <meta name="description" content="Home - Instant Wins" />
      <section className="Instant-wins" >
        <div className="container">
          <div className="Instant-wins-heading">
            <div className="Instant-wins-left"></div>
            <div className="Instant-wins-center">
              <h2>Instantly Win Prizes</h2>
            </div>
            <div className="Instant-wins-left"></div>
          </div>
