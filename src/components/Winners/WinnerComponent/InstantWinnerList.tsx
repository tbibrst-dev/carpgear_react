...
const InstantWinnerList: React.FC<PropsType> = ({ ticket }) => {
        ...
        {ticket.winners.map((data: { competition_title: any; user: any; ticket_number: any; instant_title: any; edited_title_instant:any; }) => (
          <li className="winner-list-component-main-li" key={data.ticket_number}>
            ...
            <div >
              ...
              <p><span> <span className="display-name">{data.edited_title_instant  && data.edited_title_instant != null ? data.edited_title_instant : data.instant_title}</span> - <span className="display-name user-name">{data.user}</span> Ticket  #{data.ticket_number}</span></p>
